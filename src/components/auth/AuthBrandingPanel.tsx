...
const Itm8Logo: React.FC = () => (
  ...
  >
    <defs>
      <style>{`.ab-logo { fill: #fff; stroke-width: 0px; }`}</style>
    </defs>
    <path
      className="ab-logo"
...
const AuthBrandingPanel: React.FC = () => (
  <div
    ...
    style={{
      background:
        "linear-gradient(to bottom right, rgba(95,37,159,1), rgba(95,37,159,1), rgba(100,217,164,1))",
    }}
  >
    {/* Overlay */}
    <div
      ...
      style={{
        background:
          "linear-gradient(to bottom, rgba(0,0,0,0), rgba(100,217,164,0.25))",
      }}
    />
    ...
    <div className="relative z-10 flex flex-col gap-4 max-w-md">
      ...
      <h1 className="text-white text-4xl font-bold leading-tight">
        Hantera projekt. Samla teamet. Leverera resultat.
      </h1>
      <p className="text-white/70 text-sm leading-relaxed">
        Ett samlat verktyg för projektledning, resursplanering och uppföljning -
        byggt för att hålla hela organisationen i sync.
      </p>
    </div>
